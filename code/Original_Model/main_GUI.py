...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "英文文献编辑与编译码系统"))
        self.pushButton_3.setText(_translate("MainWindow", "新建文件"))
        self.pushButton_4.setText(_translate("MainWindow", "统计词频"))
        self.pushButton_2.setText(_translate("MainWindow", "高级搜索"))
        self.pushButton_5.setText(_translate("MainWindow", "创建索引文件"))
